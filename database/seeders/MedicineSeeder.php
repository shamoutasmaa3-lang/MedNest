...
class MedicineSeeder extends Seeder
{
    ...
    {
        $medicines = [
            // Painkillers and general medicines
            ['name' => 'Paracetamol', 'description' => 'Pain reliever and fever reducer', 'category' => 'Painkillers', 'requires_prescription' => false, 'price' => 5000],
            ['name' => 'Panadol Extra', 'description' => 'Strong pain reliever', 'category' => 'Painkillers', 'requires_prescription' => false, 'price' => 7500],
            ['name' => 'Voltaren', 'description' => 'Anti-inflammatory', 'category' => 'Anti-inflammatory', 'requires_prescription' => true, 'price' => 12000],
            ...
            ['name' => 'Aspirin', 'description' => 'Pain reliever and blood thinner', 'category' => 'Painkillers', 'requires_prescription' => false, 'price' => 4000],
            ...
            ['name' => 'Ciprofloxacin', 'description' => 'Antibiotic for urinary tract infections', 'category' => 'Antibiotics', 'requires_prescription' => true, 'price' => 18000],
            ['name' => 'Doxycycline', 'description' => 'Antibiotic for acne and skin infections', 'category' => 'Antibiotics', 'requires_prescription' => true, 'price' => 20000],
            ['name' => 'Clindamycin', 'description' => 'Antibiotic for bacterial infections', 'category' => 'Antibiotics', 'requires_prescription' => true, 'price' => 22000],
            ...
            ['name' => 'Amlodipine 5mg', 'description' => 'Treatment for high blood pressure and angina', 'category' => 'Blood Pressure', 'requires_prescription' => true, 'price' => 14000],
            ['name' => 'Metformin 500mg', 'description' => 'Treatment for type 2 diabetes', 'category' => 'Diabetes', 'requires_prescription' => true, 'price' => 9000],
            ['name' => 'Insulin', 'description' => 'Treatment for type 1 and type 2 diabetes', 'category' => 'Diabetes', 'requires_prescription' => true, 'price' => 35000],
            ...
            ['name' => 'Clopidogrel', 'description' => 'Blood thinner to prevent clots', 'category' => 'Heart', 'requires_prescription' => true, 'price' => 20000],
            ...
            ['name' => 'Cetirizine', 'description' => 'Treatment for allergies and cold symptoms', 'category' => 'Allergy', 'requires_prescription' => false, 'price' => 5500],
            ['name' => 'Fexofenadine', 'description' => 'Treatment for seasonal allergies', 'category' => 'Allergy', 'requires_prescription' => false, 'price' => 10000],
            ...
            ['name' => 'Domperidone', 'description' => 'Treatment for nausea and vomiting', 'category' => 'Digestive', 'requires_prescription' => true, 'price' => 7000],
            
            // Vitamins and supplements
            ['name' => 'Vitamin C 1000mg', 'description' => 'Supplement to boost immunity', 'category' => 'Vitamins', 'requires_prescription' => false, 'price' => 10000],
            ['name' => 'Vitamin D3 5000IU', 'description' => 'Supplement for bone health', 'category' => 'Vitamins', 'requires_prescription' => false, 'price' => 15000],
            ['name' => 'Calcium + Vitamin D', 'description' => 'Supplement for bones and teeth', 'category' => 'Supplements', 'requires_prescription' => false, 'price' => 12000],
            ['name' => 'Omega-3', 'description' => 'Fatty acids for heart health', 'category' => 'Supplements', 'requires_prescription' => false, 'price' => 25000],
            ['name' => 'Zinc', 'description' => 'Supplement to boost immunity', 'category' => 'Supplements', 'requires_prescription' => false, 'price' => 8000],
            
            // Neurological and sedative medications
            ...
            ['name' => 'Ambroxol', 'description' => 'Mucolytic (relieves mucus)', 'category' => 'Respiratory', 'requires_prescription' => false, 'price' => 5000],
            ['name' => 'Pseudoephedrine', 'description' => 'Nasal decongestant', 'category' => 'Respiratory', 'requires_prescription' => false, 'price' => 6000],
            
            // Dermatological medications
            ['name' => 'Clotrimazole Cream', 'description' => 'Antifungal for skin', 'category' => 'Dermatology', 'requires_prescription' => false, 'price' => 7000],
            ['name' => 'Hydrocortisone Cream', 'description' => 'Anti-inflammatory for itching', 'category' => 'Dermatology', 'requires_prescription' => false, 'price' => 8000],
            ['name' => 'Tretinoin Cream', 'description' => 'Acne treatment', 'category' => 'Dermatology', 'requires_prescription' => true, 'price' => 20000],
        
// ==================== Painkillers & Anti-inflammatory (10) ====================
